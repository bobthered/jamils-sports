...
{#if remoteStatus === 'loading'}
	<Section><Container><Card>Loading</Card></Container></Section>
{:else}
	<Section>
		<Container>
			<Card
			...
			>
				...
				>
					...
					<H1 class={twMerge(theme.getComponentVariant('H4', 'default'))}
			...
			<Div class="flex flex-col space-y-12">
				<Div class="flex flex-col lg:flex-row lg:justify-between">
					<Div class="relative grow lg:grow-0">
						<Input
							class="w-full pl-12 lg:w-auto dark:bg-gray-950"
